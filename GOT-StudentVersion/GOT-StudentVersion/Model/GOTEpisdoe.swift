...
class GOTEpisode {
    ...
    static let combinedEpisodes: [GOTEpisode] = [GOTEpisode.season1, GOTEpisode.season2, GOTEpisode.season3, GOTEpisode.season4, GOTEpisode.season5, GOTEpisode.season6, GOTEpisode.season7].flatMap{$0}
...
extension GOTEpisode: Imageable {
    var imageName: String {return mediumImageID}
    var BigImageName: String {return originalImageID}
    func getImage() -> UIImage {
        return UIImage(named: imageName)!
    }
    func getBigImage() -> UIImage {
        return UIImage(named: BigImageName)!
    }
}
