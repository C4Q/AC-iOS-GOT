...
class GOTEpisode {
  ...
  static let seasonOneEpisodes = GOTEpisode.allEpisodes.filter({$0.season == 1})
  
  static let seasonTwoEpisodes = GOTEpisode.allEpisodes.filter({$0.season == 2})
  
  static let seasonThreeEpisodes = GOTEpisode.allEpisodes.filter({$0.season == 3})
  
  static let seasonFourEpisodes = GOTEpisode.allEpisodes.filter({$0.season == 4})
  
  static let seasonFiveEpisodes = GOTEpisode.allEpisodes.filter({$0.season == 5})
